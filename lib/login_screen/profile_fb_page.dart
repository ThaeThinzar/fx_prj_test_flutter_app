...
import 'package:fx_prj_test_flutter_app/login_screen/progress_hub.dart';
import 'package:http/http.dart' as http;
import 'dart:convert' as JSON;
class ProfileFBPage extends StatefulWidget {

  _ProfileFBPage createState() => _ProfileFBPage();
}

class _ProfileFBPage extends State<ProfileFBPage>{
